...
def _chunk_blocks(text : str, separators : Dict[str, Priority]) -> Generator[Tuple[str, int, Priority | None], None, None]:
    """
...
def chunk_text(text : str, separators : Dict[str, Priority], tokenizer : Tokenizer, max_chunk_size : int, force_chunk : bool = False) -> Generator[Tuple[str, int], None, None]:
    """
