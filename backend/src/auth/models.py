...
if TYPE_CHECKING:
    from src.glossaries.models import GlossaryContributor
...
class User(Base):
    ...
    glossary_contributors_with_user: Mapped[list["GlossaryContributor"]] = relationship(
        back_populates="user_of_contributor"
    )
